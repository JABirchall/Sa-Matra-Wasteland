...
#define wgrzqi (R3F_ARTY_ID_transporteur_START + 1)
#define wgc72r (R3F_ARTY_ID_transporteur_START + 2)
#define wgjxz2 (R3F_ARTY_ID_transporteur_START + 3)
#define wggvz6 (R3F_ARTY_ID_transporteur_START + 4)
...
#define wgnd24 (R3F_ARTY_ID_transporteur_START + 13)
#define wghrn8 (R3F_ARTY_ID_transporteur_START + 14)
#define CT_STATIC           0
#define CT_BUTTON           1
#define CT_EDIT             2
#define CT_SLIDER           3
